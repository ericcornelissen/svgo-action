...
jobs:
  triage:
    ...
    steps:
    - uses: ericcornelissen/svgo-action@v0.1.1
      with:
...
[marketplace-image]: https://img.shields.io/badge/Marketplace-v0.1.1-undefined.svg?logo=github&logoColor=white&style=flat
